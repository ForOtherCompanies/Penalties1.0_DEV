...
public class CategoriaComplemento : MonoBehaviour {
	...
	//public arraylist de botones-objeto (cada boton podria ser un 'prefab' que ya incluya el modelo y todo; el modelo estaria desactivado hasta que se seleccione y se coloque en su sitio (esto ya no es necesario)
